      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-12 lg:gap-24">
        <div className="flex-1 space-y-8 animate-fade-in">
          ...
          <p className="text-xl text-muted-foreground max-w-xl">
            A Senior Software Architect and UI/UX Designer passionate about building performant, 
            scalable, and beautiful web experiences that solve real-world problems.
          </p>
          ...
          <div className="flex items-center gap-6 pt-4">
            <LinkIcon icon={<Github />} href="https://github.com" label="GitHub" />
